...
const en: Dict = {
  ...
  home: {
    ...
    heroEyebrow: "HYPNOSIS AND PERSONAL DEVELOPMENT",
    ...
    heroSecondary: "SOLUTIONS FOR COMPANIES",
    heroHow: "Learn how hypnosis works →",
    heroImageAlt: "Natural photograph related to hypnosis",
    changeEyebrow: "INDIVIDUAL SUPPORT",
    changeTitle: "WHAT DO YOU WANT TO CHANGE?",
    changeCards: [
      {
        title: "FEARS AND AVOIDANCE",
        text: "Feel calmer in situations that currently create blocking or avoidance.",
      },
      {
        title: "STRESS AND CALM",
        text: "Work with automatic responses and learn to recover a calmer state.",
      },
      {
        title: "HABITS",
        text: "Change behaviours you repeat even when consciously you want something different.",
      },
      {
        title: "STOPPING SMOKING",
        text: "Specific support for habits and automatisms related to smoking.",
      },
      {
        title: "CONFIDENCE",
        text: "Work on personal security, inner dialogue and responses to demanding situations.",
      },
      {
        title: "FOCUS AND LEARNING",
        text: "Concentration, study, exam preparation and improving learning habits.",
      },
    ],
    changeLink: "SEE ALL AREAS",
    hypnosisEyebrow: "HYPNOSIS",
    hypnosisTitle: "YOU DO NOT LOSE CONTROL. YOU LEARN TO USE YOUR ATTENTION BETTER.",
    hypnosisText1:
      "Hypnosis is a state of focused attention in which we remain conscious and actively involved. It can support work with habits, associations, automatic responses and ways of interpreting certain situations.",
    hypnosisText2:
      "It is not about sleeping or handing control to another person. The process is collaborative and adapts to the goal of each session.",
    hypnosisLink: "HOW HYPNOSIS WORKS",
    hypnosisImageAlt: "Photograph of a calm session",
    contextsTitle: "TWO CONTEXTS. ONE SAME IDEA: CHANGING HOW WE RESPOND.",
    individualTitle: "INDIVIDUAL SESSIONS",
    individualText:
      "Personalised work on habits, confidence, fears, focus and other personal-development goals.",
    individualLink: "SEE SESSIONS",
    companiesTitle: "DEVELOPMENT AND PERFORMANCE",
    companiesText:
      "Programmes and workshops to help people better manage attention, confidence, learning and their response under pressure.",
    companiesLink: "SOLUTIONS FOR COMPANIES",
    processEyebrow: "THE PROCESS",
    processTitle: "CLEAR, PERSONAL AND PRACTICAL.",
    processSteps: [
      {
        title: "WE UNDERSTAND THE GOAL",
        text: "First we talk about what you want to change and where the current pattern appears.",
      },
      {
        title: "WE WORK WITH HYPNOSIS",
        text: "The session adapts to your goal and to your way of responding.",
      },
      {
        title: "WE INTEGRATE THE CHANGE",
        text: "We observe what has been learned and add simple practices between sessions.",
      },
    ],
    aboutEyebrow: "MARÍA CABO",
    aboutTitle: "A CLOSE AND REALISTIC WAY TO WORK WITH CHANGE.",
    aboutText:
      "My work starts from a simple idea: very often we know exactly what we want to do, but we keep reacting in another way. Hypnosis makes it possible to work with that more automatic part of our experience, while always keeping awareness, participation and control.",
    aboutLink: "ABOUT ME",
    aboutImageAlt: "María Cabo",
    eventsTitle: "GATHERINGS",
    eventsLink: "SEE EVENTS",
    eventsEmpty: "New dates are being prepared.",
    learnTitle: "LEARN",
    learnLink: "SEE ALL ARTICLES",
    faqHomeTitle: "UNDERSTANDING HYPNOSIS",
    faqHomeLink: "SEE FREQUENTLY ASKED QUESTIONS",
    ctaTitle: "CHANGE CAN BEGIN WITH A CONVERSATION.",
    ctaPrimary: "BOOK A SESSION",
    ctaSecondary: "ASK BEFORE BOOKING",
    ctaCompanies: "Representing a company? See solutions for organisations →",
  },
  how: {
    title: "How it works",
    intro:
